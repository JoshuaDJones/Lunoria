...
import DialogCharacterSelect, {
  DialogCharacter,
} from "./DialogCharacterSelect";
...
const EditPageSection = ({
  ...
  const validate = (): boolean => {
    ...
    if (
      ...
      newInputErrors.characterId =
        "Please select a character OR mark section as narrator.";
    }
  ...
  return (
    <EditDialogItemContainer
      ...
      onSaveClick={async () => save()}
      className="gap-3"
    >
      <DialogCharacterSelect
        selectedCharacter={inputValues.dialogCharacter}
