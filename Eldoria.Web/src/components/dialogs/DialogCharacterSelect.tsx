    ...
    <div className={clsx("flex items-center gap-4", className)}>
              ...
              {selectedCharacter?.characterId && (
                <div className="relative">
                  ...
                  <button className='bg-black h-[30px] w-[30px] rounded-full hover:opacity-65 cursor-pointer flex justify-center items-center absolute -top-4 -right-3' onClick={() => onCharacterSelect(undefined)}>
                  <FontAwesomeIcon
                    icon={faClose}
                    size="lg"    
