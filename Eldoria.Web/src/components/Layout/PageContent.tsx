...
const PageContent = ({ title, titleColor, children, noCentering, noTopMargin, useBackButton = false, leftPane, rightPane, className }: PageContentProps) => {
  return (
    <div
      className={
      clsx("flex flex-1 gap-2", {
