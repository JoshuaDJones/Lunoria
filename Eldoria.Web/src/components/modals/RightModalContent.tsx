...
const RightModalContent = ({
  ...
  return (
    <div
      className={`flex flex-col bg-stone-800 p-5 rounded-tl-3xl scrollbar-hide rounded-bl-3xl w-[40%] h-full overflow-y-auto absolute right-0 transform transition-transform duration-500 ease-in-out 
