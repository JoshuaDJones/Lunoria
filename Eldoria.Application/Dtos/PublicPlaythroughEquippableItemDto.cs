...
public sealed class PublicPlaythroughEquippableItemDto
{
    ...
    public string? AffectedSpellType { get; set; }
    public int? SpellDamageModifier { get; set; }
    public List<PublicPlaythroughSpellDto> AddedSpells { get; set; } = [];
}
