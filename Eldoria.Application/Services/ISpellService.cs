...
namespace Eldoria.Application.Services
{
    ...
    {
        Task<Result<List<SpellDto>>> GetListAsync(int userId, int skip, int take, int? spellTypeId, CancellationToken ct);
        ...
        Task<Result<SpellDto>> UpdateAsync(int userId, int id, string name, string description, IFormFile? photo, bool removePhoto, int range, bool isRadius, int mpCost, int? damageEffect, int? healthEffect, int? magicEffect, int spellTypeId, CancellationToken ct);
    }
}
