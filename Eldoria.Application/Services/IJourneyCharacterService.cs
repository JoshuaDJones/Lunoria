...
namespace Eldoria.Application.Services
{
    public interface IJourneyCharacterService
    {
        ...
        Task<Result<Eldoria.Application.Dtos.JourneyCharacterDto>> UpdateAsync(int userId, int journeyCharacterId, int? meleeAttackDamage, int? bowAttackDamage, int movement, int maxConsumableInventory, int maxEquippableInventory, int maxHp, int maxMp, bool isInitiallyActive, int? alternateFormId, CancellationToken ct, int? sortOrder = null);
    }
}
