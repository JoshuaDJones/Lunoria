...
namespace Eldoria.Infrastructure.Db
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<JourneyCharacterEquippableItem> JourneyCharacterEquippableItems { get; set; }
        ...
        public DbSet<SceneParticipantTurn> SceneParticipantTurns { get; set; }
        public DbSet<SceneDialog> SceneDialogs { get; set; }
        public DbSet<SceneParticipant> SceneParticipants { get; set; }
